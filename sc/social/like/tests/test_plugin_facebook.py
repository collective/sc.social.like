...
class PluginViewsTest(unittest.TestCase):
    ...
    def test_plugin_view_image(self):
        ...
        # Set a larger image
        set_image_field(image, load_image(1920, 1080), 'Image')
        image.modification_date = image.modification_date + 0.00001
    ...
    def test_plugin_view_newsitem_large(self):
        plugin = self.plugin
        newsitem = self.newsitem
        set_image_field(newsitem, load_image(1920, 1080), 'News Item')

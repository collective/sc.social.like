...
class RegistryTestCase(unittest.TestCase):
    ...
    def test_fbstupidcounterfix_record_in_registry(self):
        self.assertTrue(hasattr(self.settings, 'fbstupidcounterfix'))
        self.assertEqual(self.settings.fbstupidcounterfix, False)
    ...
    def test_records_removed_on_uninstall(self):
        ...
        records = [
            ...
            ISocialLikeSettings.__identifier__ + '.fbstupidcounterfix',
